<style>
    ...
    .wisata-navbar .navbar-brand {
        font-size: 1.5rem;
        font-weight: 700;
        color: #2d2d2d;
        text-decoration: none;
    }
    .wisata-navbar .nav-link {
        color: #666;
        font-weight: 500;
        margin: 0 1rem;
        transition: color 0.3s;
    }
    .wisata-navbar .nav-link:hover {
        color: #2d2d2d;
    }
    .wisata-navbar .btn-nav {
        border-radius: 50px;
        padding: 8px 24px;
        font-weight: 600;
        margin-left: 10px;
    }
    .wisata-navbar .btn-login {
        color: #2d2d2d;
        background: transparent;
        border: none;
    }
    .wisata-navbar .btn-signup {
        background: #2d2d2d;
        color: white;
        border: none;
    }
    .wisata-navbar .btn-signup:hover {
        background: #1a1a1a;
    }
    .btn-back {
        background: #2d5016;
    ...
    .category-badge {
        ...
        top: 15px;
        left: 15px;
        background: rgba(74, 107, 61, 0.95);
        color: white;
        padding: 6px 14px;
        border-radius: 20px;
        font-size: 12px;
    ...
    <div class="container-fluid">
        <div class="d-flex justify-content-between align-items-center">
            <div class="d-flex align-items-center">
                ...
                <a href="<?= base_url() ?>" class="navbar-brand">JogjaTrip</a>
            </div>
            
            <div class="d-flex align-items-center">
                <a href="<?= base_url('wisata') ?>" class="nav-link">Destination</a>
                <a href="<?= base_url('wisata') ?>" class="nav-link">Bookings</a>
                <a href="<?= base_url('wisata') ?>" class="nav-link">Activities</a>
            </div>
            
            <div class="d-flex align-items-center">
                <?php if ($this->session->userdata('user_id')): ?>
                    <a href="<?= base_url('profil') ?>" class="btn btn-nav btn-login"><?= $this->session->userdata('nama') ?></a>
                    <a href="<?= base_url('logout') ?>" class="btn btn-nav btn-signup">Logout</a>
                <?php else: ?>
                    <a href="<?= base_url('auth/login') ?>" class="btn btn-nav btn-login">Log in</a>
                    <a href="<?= base_url('auth/register') ?>" class="btn btn-nav btn-signup">Sign up</a>
                <?php endif; ?>
            </div>
        </div>
    </div>

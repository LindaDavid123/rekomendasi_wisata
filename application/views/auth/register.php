                ...
                <div class="auth-right">
                    ...
                    <?= form_open('auth/register', ['class' => 'register-form']) ?>
                        <div class="mb-3">
                            ...
                            <?= form_error('username', '<small class="form-error">', '</small>') ?>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <?= form_error('email', '<small class="form-error">', '</small>') ?>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="password-hint">Minimal 6 karakter, gunakan kombinasi huruf dan angka</div>
                            <?= form_error('password', '<small class="form-error">', '</small>') ?>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <?= form_error('confirm_password', '<small class="form-error">', '</small>') ?>
                        </div>
